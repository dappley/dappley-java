...
public class WalletMenuWindow extends PopupWindow {
    ...
    public WalletMenuWindow(Activity activity, OnWindowClickListener listener) {
    ...
    private void initWindow() {
        rootView = LayoutInflater.from(activity).inflate(R.layout.pop_wallet_menu, null);
